...
export default class BlogForm extends Component {
    ...
    handleSubmit(event) {
        ...
        axios.post("http://localhost:5000/blog", { title: this.state.title, content: this.state.content, imageURL: this.state.imageURL }) // dont forget to add { withCredentials: true} so it requires authentication.
        .then(response => {
        ...
        return (
            <div>
                <form onSubmit={this.handleSubmit}>
                    ...
                    <input onChange={this.handleChange} type="text" name="content" placeholder='Content' value={this.state.content}/>
